...
do
	...
	python3 /media/ehsan/Learn/SUT/model_gator/model_inputs=504/normalized/dataset_model_input\=504_crop_normal.py /media/ehsan/Learn/SUT/model_gator/model_inputs=504/normalized/Data/$2/$FFF/

	python3 /media/ehsan/Learn/SUT/model_gator/model_inputs=504/normalized/fig.py /media/ehsan/Learn/SUT/model_gator/model_inputs=504/normalized/Data/$2/$FFF
