# This script read counters in captured.xml file and fill details of these counters to a dictionary(p) using events.xml file
# It also read the map key of counter keys stored in counters_mapping.csv (you should prepare it before)
# Then it saves these info in counters_info.csv file
...
# Find start and end lines containing A53 counters info in events.xml
...
# Find start and end lines containing A73 counters info in events.xml
...
# Fill p dictionary of captured.xml counters in events.xml file
p={}
for line in caplines:
	c=line.find('key=')
	if c>-1:
