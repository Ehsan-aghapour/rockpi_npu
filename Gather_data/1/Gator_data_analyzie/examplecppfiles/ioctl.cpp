...
//bool cap=false;
#define next_state _IO(0x01,'n')
#define capture_freqs _IOR(0x01,'c',struct frequencies *)
#define next_freq _IOW(0x01,'f', int*)
//new
#define Apply_freqs _IOW(0x01,'a', int8_t**)
